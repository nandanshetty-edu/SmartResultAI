...
class ProcessingService:
    ...
    def upload(pdf, excel):
        ...
        pdf_path = FileUtils.save_file(pdf, "uploads/pdf")

        excel_path = FileUtils.save_file(excel, "uploads/excel")
    ...
    def process(pdf_path, exam):
        ...
        for parsed_student in parsed_students:
            ...
            student = StudentService.get_or_create(parsed_student)
            ...
            for parsed_subject in parsed_student.subjects.values():
                ...
                MarkService.create_mark(
                    result=result, subject=subject, parsed_subject=parsed_subject
                )
